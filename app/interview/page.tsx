const questions = [
  {
    id: 1,
    type: "Technical",
    question: "Can you explain the difference between Server Components and Client Components in Next.js?",
    hint: "Focus on rendering location, interactivity, and when to use each.",
  },
  {
    id: 2,
    type: "Technical",
    question: "How do you manage global state in a large React application?",
    hint: "Mention Context API, Redux, Zustand or Jotai and when to choose each.",
  },
  {
    id: 3,
    type: "Technical",
    question: "What strategies do you use to optimize performance in a React app?",
    hint: "Talk about lazy loading, memoization, code splitting, and React.memo.",
  },
  {
    id: 4,
    type: "Behavioral",
  ...
  },
  {
    id: 5,
    type: "Behavioral",
    question: "How do you handle disagreements with your team about technical decisions?",
    hint: "Show empathy, communication skills and willingness to compromise.",
  },
  {
    id: 6,
    type: "Technical",
    question: "What is your approach to writing clean and maintainable code?",
    hint: "Mention naming conventions, folder structure, comments and code reviews.",
  },
  {
    id: 7,
    type: "Situational",
    question: "If you joined a team with a legacy codebase, how would you approach modernizing it?",
    hint: "Talk about incremental refactoring, testing before changes, and team alignment.",
  },
  {
    id: 8,
    type: "Behavioral",
    question: "Describe a challenging bug you faced and how you resolved it.",
    hint: "Walk through your debugging process step by step.",
  },
];
    ...
    <main className="min-h-screen bg-white font-sans">
      ...
      <div className="max-w-2xl mx-auto px-6 pt-14 pb-6">
        ...
        <p className="text-sm text-gray-400 font-light leading-relaxed">
          8 predicted questions based on your job description — practice your answers before the big day.
        </p>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-6 mb-8">
        <div className="flex items-center gap-6 bg-gray-50 border border-gray-100 rounded-xl px-6 py-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 uppercase tracking-wide">Technical</p>
          </div>
          <div className="w-px h-8 bg-gray-200" />
          <div>
            <p className="text-lg font-semibold text-amber-600">2</p>
            <p className="text-xs text-gray-400 uppercase tracking-wide">Behavioral</p>
          </div>
          <div className="w-px h-8 bg-gray-200" />
          <div>
            <p className="text-lg font-semibold text-purple-600">1</p>
            <p className="text-xs text-gray-400 uppercase tracking-wide">Situational</p>
          </div>
        </div>
      </div>
        ...
        {questions.map((q) => (
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              <span className="text-xs font-semibold text-gray-400">Q{q.id}</span>
              <span className={`text-[10px] font-medium px-2.5 py-0.5 rounded-full ${badgeStyles[q.type]}`}>
                {q.type}
              </span>
            </div>
      ...
      <div className="max-w-2xl mx-auto px-6 pb-20 text-center">
        <p className="text-sm text-gray-400 mb-4">You are all set! Good luck with your interview. 🎉</p>
        <a
          href="/upload"
